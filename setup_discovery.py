...
def main():
    ...
    for cidr in cidrs_to_add:
        DiscoveryCIDR.objects.get_or_create(manufacturer=manufacturer, cidr=cidr)

    # Add FQDNs
    fqdns_to_add = [
        "howeyl3wm.amx.gatech.edu",
        "howeyl4wm.amx.gatech.edu",
        "howeyl1wm.amx.gatech.edu",
    ]
    for fqdn in fqdns_to_add:
        DiscoveryFQDN.objects.get_or_create(manufacturer=manufacturer, fqdn=fqdn)
