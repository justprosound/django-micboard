...
# Structured logging (minimal demo setup)
LOGGING = {
    "version": 1,
    ...
    "loggers": {
        "micboard": {"handlers": ["console"], "level": "INFO", "propagate": False},
        "micboard.services": {"handlers": ["console"], "level": "INFO", "propagate": False},
    },
}
