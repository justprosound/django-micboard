...
async def connect_and_subscribe(client, device_id: str, callback: Callable[[dict[str, Any]], None]):
    """
    ...
    try:
        ...
        with requests.get(sse_url, headers=headers, stream=True, verify=client.verify_ssl) as response:
