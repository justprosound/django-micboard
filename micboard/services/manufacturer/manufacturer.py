...
class ManufacturerService:
        ...
        *,
        ...
        try:
            ...
            for payload in normalized_devices:
                ...
                # Moved device: update IP and mark online
                ...
                # Duplicate match: update and conditionally mark online
                if dedup_result.is_duplicate and dedup_result.existing_device:
                    ...
                    # Direct status update if not already in a stable state
                ...
                # New device: create and mark online
    ...
    @staticmethod
    def handle_manufacturer_save(*, manufacturer, created: bool, old_active: bool) -> None:
        ...
        # Trigger discovery sync when manufacturer becomes active
