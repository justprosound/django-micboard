...
"""Initial multitenancy schema for organizations, campuses, and memberships."""
...
class Migration(migrations.Migration):
    """Create multitenancy tables and relationships."""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="URL-safe identifier (unique within org)", max_length=200
                    ),
                ),
                ...
                (
                    "is_active",
                    models.BooleanField(default=True, help_text="Whether campus is active"),
                ),
        ...
        migrations.AddIndex(
            model_name="campus",
            index=models.Index(
                fields=["organization", "is_active"], name="micboard_mu_organiz_92504f_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="organizationmembership",
            index=models.Index(
                fields=["organization", "is_active"], name="micboard_mu_organiz_e423e3_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="organizationmembership",
